 ...
 * MCPLAY
 * Uses ESP32-S2 MCU
 * we edited the library and I/O pins definition only
 * no changes for all the rest of the original Makey Makey firmware
 * 
 * Modified by : Insan Sains
...
// Instead using Keyboard.h and Mouse.h, 
// we use USB.h, USBHIDMouse.h, and USBHIDKeyboard.h
#include "USB.h"
...
// up, down, left, right, space, left click
  9, 4, 5, 10, 21, 15,     // top of mcplay
// w, a, s, d, f, g
  36, 35, 16, 17, 33, 18,        // left side of female header, KEYBOARD
// up, down, left, right, left click, right click
  8, 7, 6, 3, 2, 1   // right side of female header, MOUSE
};

// input status LED pin numbers
const int inputLED_a = 37;
const int inputLED_b = 38;
const int inputLED_c = 11;
const int outputK = 12;
const int outputM = 34;
